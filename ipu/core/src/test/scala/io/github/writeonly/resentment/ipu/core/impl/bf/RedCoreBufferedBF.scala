...
import io.github.writeonly.resentment.ipu.core.impl.fake.{ComplexCoreComparator, RedCoreFake}
import io.github.writeonly.resentment.ipu.core.impl.wrapper.{RedCoreBuffered, RedCoreToString}
...
class RedCoreBufferedBF extends RedCoreBuffered(new RedCoreToStringBF(), new BufferedInterpreterBF)

class ComplexCoreComparatorBF extends ComplexCoreComparator(new RedCoreBufferedBF, new RedCoreFake)
