...
import io.github.writeonly.resentment.ipu.core.api.Meta
import io.github.writeonly.resentment.ipu.core.common.FString

class OrtoBF extends MetaBF with Meta[Orto] {
  ...
  override lazy val add = new Orto1 {
  ...
  override lazy val sub = new Orto1 {
    override def tmp(r: (Int, Int), t: Int*): FString =
  ...
  override lazy val mov = new Orto1 {
    override def tmp(r: (Int, Int), t: Int*): FString =
  ...
  override lazy val mul = new OrtoCl {
...
//[->-[>+>>]>[+[-<+>]>+>>]<<<<<]
  ...
  //[>->+<[>]>[<+>-]<<[<]>-]
  override lazy val mod = new OrtoTmp {
  ...
  override lazy val leq = new OrtoTmp {
    override def dir(r: (Int, Int)): FString =
      mkm(add.cl(r._2, -2),
          rinc(r._2),
          sub.tmp((r._1, -2), -1),
  ...
  override lazy val lne = new OrtoTmp {
    override def dir(r: (Int, Int)): FString =
  ...
  override lazy val lle = new OrtoTmp {
  ...
  override lazy val llt = new OrtoTmp {
...
//  y- x- ]
  ...
  //    temp1[x+temp1[-]]
  //  ]
  override lazy val land = new OrtoTmp {
    override def dir(r: (Int, Int)): FString =
      mkm(add.cl(r._2, -2),
  ...
  //  temp0[y+temp0-]
  //  temp1[x[-]-temp1[-]]
  override lazy val lor = new OrtoTmp {
