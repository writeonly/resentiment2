...
case class UnaryOperation(operator: String, left: Command)
    extends BlockOperation

case class BinaryOperation(operator: String, left: Command, right: Command)
    extends BlockOperation
...
case class BinaryOperator(operator: String, left: Command, right: Command)
    extends Command
